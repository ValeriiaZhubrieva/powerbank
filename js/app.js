(() => {
    ...
    function menuInit() {
        if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
            ...
            if (e.target.closest(".menu__link") || e.target.closest(".header__btn")) menuClose();
        }));
    }
    function menuClose() {
        bodyUnlock();
    ...
    function initSliders() {
        if (document.querySelector(".slider")) new Swiper(".slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
    ...
    const timerBlock = document.querySelectorAll(".timer");
    if (timerBlock.length) timerBlock.forEach((timer => {
        function startTimer(endTime) {
            ...
            function updateTimer() {
                ...
                if (timeLeft <= 0) {
                    ...
                    daysElement.textContent = "0 днів";
                ...
                let daysText = days + " " + getDayText(days);
            ...
            function getDayText(days) {
                if (days === 1) return "день"; else if (days >= 2 && days <= 4) return "дні"; else return "днів";
            }
    ...
    document.addEventListener("click", (e => {
        ...
        const videoBlock = document.querySelector(".video-review__video video");
        if (targetElement.closest(".video-review__play-btn")) {
            targetElement.closest(".video-review__video").classList.add("video-play");
